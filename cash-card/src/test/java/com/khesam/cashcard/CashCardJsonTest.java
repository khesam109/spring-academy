 ...
 *
 * <a href="https://github.com/json-path/JsonPath">To learn more about JsonPath</a>
 */
@JsonTest
public class CashCardJsonTest {
    ...
    void cashCardDeserializationTest() throws IOException {
        ...
        assertThat(
                json.parseObject(expected).id()
        ).isEqualTo(
                99L
        );

        assertThat(
                json.parseObject(expected).amount()
        ).isEqualTo(
                123.45
        );
    }
